...
<p>Der manuelle Import der <strong><a href="{{ $admin_url }}/instances/{{ $instance_id }}" target="_blank">{{ $instance_name }}</a></strong> Instanz ist fehlgeschlagen.</p>
...
<table>
    <tbody>
        ...
        <tr>
            <th style="width: 33%;">Aktueller Fortschritt</th>
