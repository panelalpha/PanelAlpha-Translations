...
<p>Die folgenden DNS-Einträge für die Zone <strong>{{ $zone_name }}</strong> kann nicht erstellt werden:</p>
<table>
    <tbody>
    <tr>
        <th style="text-align: left">DNS-Eintrag</th>
        <th style="text-align: left">Mitteilung</th>
    </tr>
...
<table>
    ...
    <tr>
        <th style="text-align: left">Dienstleistung</th>
