...
<p>Neue Updates für WordPress-Plugins sind jetzt für Ihre Instanzen verfügbar:</p>
...
@endforeach
<p style="text-align: left;">Bitte melden Sie sich bei Ihrem Konto an, um mit der Aktualisierung Ihrer Plugins fortzufahren.</p>
<div style="width: 100%; text-align: center; margin-top: 32px;">
    ...
    <![endif]--> <a
            ...
            href="{{ $app_url }}/instances"> Anmelden </a> <!-- [if mso]>
        </v:roundrect>
        </center>
        <![endif]--></p>
</div>
