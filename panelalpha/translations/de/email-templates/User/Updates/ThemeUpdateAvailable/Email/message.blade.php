...
@foreach ($themes as $themesAssingedToInstance)
    <table style="margin-top: 16px; padding: 10px 16px;">
        ...
        <tr class="table-row" style="margin-bottom: 10px;">
            ...
            <td style="width: 50%; margin-left: auto;">@foreach ($themesAssingedToInstance["Themen"] as $theme)
...
@endforeach
<p style="text-align: left;">Bitte melden Sie sich bei Ihrem Konto an, um Themen zu aktualisieren.</p>
