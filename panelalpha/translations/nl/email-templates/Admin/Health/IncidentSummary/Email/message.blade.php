...
<p>De volgende systeemincidenten zijn gedetecteerd:</p>

<p><strong>Gegevens van het afgelopen uur ({{ $time_from }} - {{ $time_to }})</strong></p>
        ...
        <ul>
            @foreach($entity['incidents'] as $incident)
                <li style="margin-bottom: 6px;">
                    <span>{{ $incident['incident_label'] }}: {{ $incident['incident_occurrences'] }} keer voorgekomen</span><br>
