...
<p>Des mises à jour d’extensions WordPress sont disponibles pour vos instances :</p>
...
@endforeach
<p style="text-align: left;">Veuillez vous connecter à votre compte pour procéder à la mise à jour.</p>
<div style="width: 100%; text-align: center; margin-top: 32px;">
    ...
    <![endif]--> <a
            ...
            href="{{ $app_url }}/instances"> Connection </a> <!-- [if mso]>
        </v:roundrect>
        </center>
        <![endif]--></p>
</div>
