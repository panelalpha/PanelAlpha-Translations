...
<p>La synchronisation des fournisseurs de rapports pour <strong><a href="{{ $admin_url }}/instances/{{ $instance_id }}" target="_blank">{{ $instance_name }}</a></strong> a été correctement effectuée.</p>
