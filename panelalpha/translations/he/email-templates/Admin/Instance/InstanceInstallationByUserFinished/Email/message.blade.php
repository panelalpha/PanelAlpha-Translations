...
<p>ה <strong><a href="{{ $admin_url }}/instances/{{ $instance_id }}" target="_blank">{{ $instance_name }}</a></strong>מופע על ידי    <strong><a href="{{ $admin_url }}/users/{{ $client_id }}">{{ $client_name }}</a></strong> has been installed
    successfully.</p>
<p>פרטי המופע:</p>
<table>
    <tbody>
