...
<p>זוהו התקריות המערכתיות הבאות:</p>

<p><strong>נתונים מהשעה האחרונה ({{ $time_from }} - {{ $time_to }})</strong></p>
        ...
        <ul>
            @foreach($entity['incidents'] as $incident)
                <li style="margin-bottom: 6px;">
                    <span>{{ $incident['incident_label'] }}: {{ $incident['incident_occurrences'] }} אירוע/ים</span><br>
