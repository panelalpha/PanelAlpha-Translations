...
<p>החשבון שלך נוצר בהצלחה, ויש לך גישה ללוח הבקרה שלנו.</p>
<p>התחבר באמצעות הכפתור הבא:</p>
<div style="width: 100%; text-align: center; margin-top: 32px; margin-bottom: 32px;">
    ...
    <![endif]--> <a
            ...
            href="{{ $app_url }}/login"> גישה ללוח הבקרה שלנו </a> <!-- [if mso]>
        </v:roundrect>
        </center>
        <![endif]--></p>
</div>
<p>השתמש בפרטי הכניסה שלמטה לגישה:</p>
<p>אימייל: {{ $email }}</p>
<p>סיסמה: {{ $plain_password  }}</p>
<p>מטעמי אבטחה, אנו ממליצים בחום שתשנה את הסיסמה שלך בהתחברות הראשונה.</p>
<p>אם נדרשת עזרה נוספת, פנה לצוות התמיכה שלנו.</p>
