<p>שלום,</p>
<p><strong>{{ $inviting_name }}</strong> הזמין אותך לגשת לניהול מופע WordPress עבור    <strong>{{ $instance_name }}</strong>.</p>
<p>פרטי המופע:</p>
<table>
    <tbody>
    <tr>
...
<p>לחץ על הכפתור למטה כדי לגשת למופע ה-WordPress.</p>
<div style="width: 100%; text-align: center; margin-top: 32px;">
    ...
    <![endif]--> <a
            ...
            href="{{ $access_url }} "> Access Now</a> <!-- [if mso]>
        </v:roundrect>
        </center>
        <![endif]--></p>
</div>
