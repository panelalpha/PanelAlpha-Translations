...
<p>עדכונים חדשים לערכות עיצוב של WordPress זמינים כעת עבור המופעים שלך:</p>
...
@endforeach
<p style="text-align: left;">התחבר לחשבונך כדי לעדכן ערכות עיצוב.</p>
<div style="width: 100%; text-align: center; margin-top: 32px;">
    ...
    <![endif]--> <a
            ...
            href="{{ $app_url }}/instances"> התחבר </a> <!-- [if mso]>
        </v:roundrect>
        </center>
        <![endif]--></p>
</div>
