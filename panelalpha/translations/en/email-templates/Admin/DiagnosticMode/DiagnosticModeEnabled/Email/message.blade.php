...
<div style="width: 100%; text-align: center; margin-top: 32px; margin-bottom: 32px;">
    ...
    <![endif]--> <a
            ...
            href="https://www.panelalpha.com/documentation/multi-server/system-configuration/diagnostic-mode-and-health-check/"> Read More About Diagnostic Mode </a> <!-- [if mso]>
        </v:roundrect>
        </center>
        <![endif]--></p>
    <p class="button" style="display: inline; text-align: center; margin-right: auto;"><!-- [if mso]>
