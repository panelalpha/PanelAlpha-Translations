...
<p>Uma nova atualização do WordPress já está disponível para suas instâncias:</p>
...
@endforeach
<p style="text-align: left;">Faça login em sua conta para atualizar as instâncias instaladas.</p>
