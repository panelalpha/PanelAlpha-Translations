...
<p>Novas atualizações para temas do WordPress já estão disponíveis para suas instâncias:</p>
...
@endforeach
<p style="text-align: left;">Faça login em sua conta para atualizar os temas.</p>
