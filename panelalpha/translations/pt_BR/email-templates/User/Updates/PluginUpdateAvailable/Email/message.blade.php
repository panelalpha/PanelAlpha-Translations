...
<p>Novas atualizações para plug-ins do WordPress já estão disponíveis para suas instâncias:</p>
...
@endforeach
<p style="text-align: left;">Faça login em sua conta para prosseguir com a atualização de seus plug-ins.</p>
<div style="width: 100%; text-align: center; margin-top: 32px;">
    ...
    <![endif]--> <a
            ...
            href="{{ $app_url }}/instâncias"> Fazer login </a> <!-- [if mso]>
        </v:roundrect>
        </center>
        <![endif]--></p>
</div>
