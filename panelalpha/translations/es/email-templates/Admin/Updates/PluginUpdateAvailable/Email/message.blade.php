...
<p>A continuación se muestra una lista de instancias que pueden requerir actualizaciones de plugins:</p>
            ...
            <tr style="margin-top: 8px;">
                <td style="padding-left: 20px;">
                    <ul style="padding: 0; margin: 0;">@foreach ($item["plugins"] as $plugin)
                            <li>{{ $plugin["title"] }} ({{ $plugin["version"] }} → {{ $plugin["update_version"] }})</li> <li>
                        @endforeach</ul>
                </td>
            </tr>
            </tbody>
