...
<p>Sincronización de los proveedores de informes <strong><a href="{{ $admin_url }}/instances/{{ $instance_id }}"
                                                  target="_blank">{{ $instance_name }}</a></strong> instancia ha fallado.
</p>
