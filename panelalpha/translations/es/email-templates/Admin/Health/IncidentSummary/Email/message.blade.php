...
<p>Se han detectado los siguientes incidentes del sistema:</p>

<p><strong>Datos de la última hora ({{ $time_from }} - {{ $time_to }})</strong></p>
        ...
        <ul>
            @foreach($entity['incidents'] as $incident)
                <li style="margin-bottom: 6px;">
                    <span>{{ $incident['incident_label'] }}: {{ $incident['incident_occurrences }} ocurrencia(s)</span><br>
