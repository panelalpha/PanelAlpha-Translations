...
<p>Ya están disponibles las nuevas actualizaciones de los plugins de WordPress para sus instancias:</p>
...
@endforeach
<p style="text-align: left;">Por favor, inicie sesión en su cuenta para proceder a la actualización de sus plugins.</p>
