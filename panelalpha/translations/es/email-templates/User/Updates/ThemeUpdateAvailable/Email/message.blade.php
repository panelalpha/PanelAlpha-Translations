...
<p>Ya están disponibles las nuevas actualizaciones para los temas de WordPress:</p>
@foreach ($themes as $themesAssingedToInstance)
    <table style="margin-top: 16px; padding: 10px 16px;">
        ...
        <tr class="table-row" style="margin-bottom: 10px;">
            ...
            <td style="width: 50%; margin-left: auto;">@foreach ($themesAssingedToInstance["temas"] as $theme)
...
@endforeach
<p style="text-align: left;">Por favor, inicia sesión en tu cuenta para actualizar temas.</p>
<div style="width: 100%; text-align: center; margin-top: 32px;">
    ...
    <![endif]--> <a
            ...
            href="{{ $app_url }}/instances"> Iniciar sesión </a> <!-- [if mso]>
        </v:roundrect>
        </center>
        <![endif]--></p>
</div>
