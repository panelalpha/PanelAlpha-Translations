...
<p>Ya está disponible una nueva actualización de WordPress para sus instancias:</p>
...
@endforeach
<p style="text-align: left;">Por favor, inicie sesión en su cuenta para actualizar las instancias instaladas.</p>
