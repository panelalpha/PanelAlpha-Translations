...
<p>È ora disponibile un nuovo aggiornamento di WordPress per le vostre istanze:</p>
...
@endforeach
<p style="text-align: left;">Accedere al proprio account per aggiornare le istanze installate.</p>
