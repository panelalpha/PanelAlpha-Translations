...
<p>Nuovi aggiornamenti per i temi di WordPress sono ora disponibili per le vostre istanze:</p>
@foreach ($themes as $themesAssingedToInstance)
    <table style="margin-top: 16px; padding: 10px 16px;">
        ...
        <tr class="table-row" style="margin-bottom: 10px;">
            ...
            <td style="width: 50%; margin-left: auto;">.@foreach ($themesAssingedToInstance["temi"] as $theme)
...
@endforeach
<p style="text-align: left;">Per aggiornare i temi, accedere al proprio account.</p>
